---
name: Mini QA Tickets Training Agent
description: This agent provides guidelines and best practices for automating the Mini QA Tickets training web app using Playwright.
tools: [vscode, execute, read, agent, edit, edit, search, web, browser,'pylance-mcp-server/*',todo]
---
